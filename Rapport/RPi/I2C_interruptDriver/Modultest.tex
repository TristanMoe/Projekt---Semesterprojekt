...
\end{figure}
For at se tests med analog discovery og en mere detaljeret overblik over testen, henvises til afsnit \fullref{sec:I2C_interruptDriver_modultest_bilag} i bilag.
\end{document}