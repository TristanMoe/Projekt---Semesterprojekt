...
\begin{tabular}{lll}
\hline
\multicolumn{1}{|l|}{\textbf{Kommando navn}} & \multicolumn{1}{l|}{\textbf{Kommando værdi (Binær)}} & \multicolumn{1}{l|}{\textbf{Beskrivelse}} \\ \hline
\multicolumn{1}{|l|}{\textbf{CUPS}} & \multicolumn{1}{l|}{00000000 - 00111111} & \multicolumn{1}{l|}{Hvert bit angiver en kop.} \\ \hline
 &  & 
\end{tabular}%
}
\end{table}
...
\multirow{2}{*}{\textbf{Team color indicator}} & 0x01 & \begin{tabular}[c]{@{}l@{}}'myColor', angiver at dette \\ er Playerside's egen farve\end{tabular} \\ \cline{2-3} 
 & 0x02 & \begin{tabular}[c]{@{}l@{}}'opponentColor', angiver at dette\\  er Playerside's modstanders farve\end{tabular} \\ \hline
