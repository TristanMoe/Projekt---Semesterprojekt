...
%Derudover kan det ud afsnit\textbf{\ref{sec:CupSensorCurrentTest} \nameref{sec:CurrentTest}} kan det ses at under normale omstændigheder, dvs. at der er ikke noget spejl eller nogen kraftige IR lyskilder, vil der maksimalt løbe $25\si{\mu A}$ igennem en fotodiode. Hvis der benyttes 4 fotodioder til hver kop, vil der for hver kop løbe en strøm på maksimalt $100\si{\mu A}$. 
